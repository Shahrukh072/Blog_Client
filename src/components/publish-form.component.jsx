...
const PublishedForm = () =>{
    ...
    const publishBlog = (e) =>{
        ...
        if(!des.length || des.length > characterLimit){
            return toast.error( `Write blog description before publish ${characterLimit }character to publish`)
        }
        if(!tags.length){
            return toast.error("Write at least one tag")
        }
        ...
        axios.post("http://localhost:4040/create-blog", { ...blogObj, id: blog_id}, {
            headers: {
    ...
    return(
       ...
       lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <button className="w-12 h-12 absolute right-[5vw] 
        z-10 top-[5%] lg:top-[10%]"
         onClick={handleClosedEvent}
        >
        ...
        <div className="max-w-[550px] center">
           ...
           bg-grey mt-4 ">
            ...
            <h1 className="text-4xl font-medium mt-2 leading-tight
            line-clamp-2">
                    {
                        title
                    }
        ...
        <div className=" border-grey lg:border-1 lg:pl-8">
            ...
            <p className="text-dark-grey mb-2 mt-9">Short Descption about your blog</p>
            <textarea 
           ...
           <p className="mt-1 text-dark-grey text-sm text-right">
            ...
            <div className="relative input-box pl-2 py-2 pb-4">
                 ...
                 { 
                    tags.map((tag, i) =>{
                     return <Tag tag={tag} tagIndex={1} key={i}/>
                    })
                 }
            </div>
