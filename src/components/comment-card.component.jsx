...
const CommentCard = ({index, leftVal, commentData}) =>{
    ...
    const getParentIndex = () =>{
        ...
        try{
            while(commentData[startingPoint].childrenlevel  >= commentData.childrenlevel){
              startingPoint--;
        }
    } catch{
    ...
    const loadReplies = ({skip = 0}) =>{
      ...
      if(children.length){
        ...
        axios.post("http://localhost:4040/get-replies", {_id, skip})
        .then(({data: {replies}}) =>{
    ...
    const deleteComment = (e) =>{
        ...
        axios.post("http://localhost:4040/delete-comment", {_id}, {
            headers:{
    ...
    return(
        <div className="w-full" style={{paddingLeft: `${leftVal * 10}px` }}>
            ...
            <div className="my-5 p-6 rounded-md border border-grey ">
                ...
                <div className="flex gap-5 items-centermt-5">
